...
**ブランドカラー維持**：  
`--color-primary: #1e40af`（深青）/ `--color-accent-purple: #765fc4`（紫）をベースに、白地 + グレーのコントラストで読みやすさを確保。

> 2026-08-03 追記: ロゴのグラデーションを刷新し、紫を `#987ad6` → `#765fc4`、終端のピンク `#f472b6` → 赤 `#e62e45` に変更。本項の値は更新後のもの。
