...
この記事は実際に混同した案件の話です。ライフサイクルステージそのものの定義、既定8段階の意味、前にしか進まない仕様は、[ライフサイクルステージとは何か。HubSpotでの定義と、設計で先に決めること](/notes/lifecycle-stage-definition-and-design/)にまとめました。
