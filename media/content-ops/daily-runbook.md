...
7. **アイキャッチ（ブラウザRecraftで生成）**：
   - Claude-in-Chrome で Recraft（プロジェクト https://www.recraft.ai/project/0cef7131-84ca-4262-9bef-01e589c0228d ）を開き、記事内容に合うプロンプトで画像を生成する。トーンは全記事共通で「Editorial documentary photograph, <被写体>, natural light, muted calm color palette, shallow depth of field, no text, no logo」。アスペクト比は 2:1。
