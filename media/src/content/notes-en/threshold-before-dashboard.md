---
title: "Before you add another Japan dashboard, write the threshold"
description: "HQ can see the Japan numbers and still cannot get a decision out of the Japan team. The gap is rarely visibility. It is that no one has written what each number has to reach before anyone acts. Here is how to fix that with one line per metric."
publishedAt: 2026-08-01
category: data
principle: "Write what each number has to reach and what happens when it does, before you build the view. A metric with no agreed threshold does not produce a decision in Japan, it produces another meeting."
